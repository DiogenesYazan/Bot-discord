...
exports.run = async (client, message, args) => {
    ...
    .addField(":gift: Nome", message.guild.name, client.user.avatarURL())
    .addField(`:pencil:  Adm do Server `, `<@${message.guild.ownerID}>`, true)
    .addField(`:pencil:  ID do Adm Server`, message.guild.ownerID, true)
    .addField(':date: Server Criado em', message.guild.createdAt, true)
    .addField(`:closed_lock_with_key: Server Verificação Level`, message.guild.verificationLevel, true)
